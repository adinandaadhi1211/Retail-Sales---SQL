...
-- Write a SQL query to retrieve all transactions where the category is 'clothing' and the quantity sold is 
...
-- Write a SQL query to create each shift and number of orders(Example Morning <12, afternoon 12 - 17 and 
-- evening >17)
